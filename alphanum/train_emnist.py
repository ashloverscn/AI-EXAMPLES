...
class EnhancedResCNN(nn.Module):
    def __init__(self, num_classes=47):
        ...
        self.fc2 = nn.Linear(128, num_classes)  # 47 classes for EMNIST Balanced split
        self.relu = nn.ReLU(inplace=True)
...
def main():
    ...
    if not os.path.exists(dataset_path):
        print(f"[Error] Dataset directory '{dataset_path}' not found! Please run your EMNIST extraction script first.")
        return
    ...
    print(f"Loaded dataset with {num_classes} distinct alphanumeric classes.")
    ...
    if os.path.exists(MODEL_PATH):
        ...
        try:
            ...
            print(f"[Warning] Could not load weights directly (likely due to class count difference): {e}")
            print("Training model from scratch for EMNIST...")
    ...
    print(f"\nStarting EMNIST training with Early Stopping protection...\n")
