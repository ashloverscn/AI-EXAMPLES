...
def enhance_and_preprocess_roi(roi_bgr):
    ...
    if contours:
        ...
        if w > 5 and h > 5:
            ...
            # EMNIST datasets are stored transposed/rotated in Torchvision.
            # Aligning ROI orientation with EMNIST standard orientation:
            final_img = cv2.transpose(final_img)
...
def main():
    ...
    window_name = 'Webcam Filtered EMNIST Recognition'
